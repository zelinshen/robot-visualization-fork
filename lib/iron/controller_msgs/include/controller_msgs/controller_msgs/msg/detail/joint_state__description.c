...
static char controller_msgs__msg__JointState__TYPE_NAME[] = "controller_msgs/msg/JointState";
...
static char controller_msgs__msg__JointState__FIELD_NAME__tau[] = "tau";
static char controller_msgs__msg__JointState__FIELD_NAME__na[] = "na";

static rosidl_runtime_c__type_description__Field controller_msgs__msg__JointState__FIELDS[] = {
  {
    {controller_msgs__msg__JointState__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {controller_msgs__msg__JointState__FIELD_NAME__q, 1, 1},
    {
  ...
  {
    {controller_msgs__msg__JointState__FIELD_NAME__v, 1, 1},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT_UNBOUNDED_SEQUENCE,
      0,
      0,
  ...
  {
    {controller_msgs__msg__JointState__FIELD_NAME__vd, 2, 2},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT_UNBOUNDED_SEQUENCE,
      0,
      0,
  ...
  {
    {controller_msgs__msg__JointState__FIELD_NAME__tau, 3, 3},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT_UNBOUNDED_SEQUENCE,
      0,
      0,
  ...
  {
    {controller_msgs__msg__JointState__FIELD_NAME__na, 2, 2},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription controller_msgs__msg__JointState__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
...
controller_msgs__msg__JointState__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *controller_msgs__msg__JointState__get_individual_type_description_source(NULL),
